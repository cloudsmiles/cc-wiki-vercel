...
![Untitled](RPG从零开始/Web/HTTP/HTTP安全/TLS1%203连接/Untitled.png)

### 握手分析

inux 上用 OpenSSL1.1.1 编译了一个支持 TLS1.3 的 Nginx，用 Wireshark 抓包存到了 GitHub 上，用它就可以分析 TLS1.3 的握手过程。

![Untitled](RPG从零开始/Web/HTTP/HTTP安全/TLS1%203连接/Untitled%201.png)
...
[https://time.geekbang.org/column/article/110718](https://time.geekbang.org/column/article/110718)