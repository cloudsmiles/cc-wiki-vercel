...
![Untitled](RPG从零开始/Program%20Language/Go/高级/标准库/database%20sql/Untitled.png)

## **1 简易教程**

首先通过一个简单的交互场景，向大家展示一下如何基于标准库 database/sql 完成一笔关系型数据库的查询操作，场景如下：

- **注册数据库驱动：**使用数据库类型为 mysql，通过匿名导入 package:[http://github.com/go-sql-driver/mysql](https://link.zhihu.com/?target=http%3A//github.com/go-sql-driver/mysql)，在该 pkg 的 init 函数中完成驱动的注册操作（这部分内容将在下期展开）
- **定义数据模型：**创建一个 user 表，里面包含一个 int64 类型的 userID 字段
- **创建数据库实例：**调用 database/sql 库的 Open 方法，填入 mysql 的 dsn（包含用户名、密码、ip、端口、数据库名等信息），完成数据库实例创建**（注意：sql.Open 方法只创建db 实例，还未执行任何连接操作，如需测试网络、鉴权等，可以t通过 ping 方法实际发起连接）**
...
![https://pic4.zhimg.com/80/v2-bd981e76df19ad674518a4d434764693_1440w.webp](https://pic4.zhimg.com/80/v2-bd981e76df19ad674518a4d434764693_1440w.webp)
...
![https://pic2.zhimg.com/80/v2-d0a7d20b382f382a9d1751d508cc20a1_1440w.webp](https://pic2.zhimg.com/80/v2-d0a7d20b382f382a9d1751d508cc20a1_1440w.webp)
...
![https://pic1.zhimg.com/80/v2-f7a7b3b08d6ee9c63e0d413c4063737c_1440w.webp](https://pic1.zhimg.com/80/v2-f7a7b3b08d6ee9c63e0d413c4063737c_1440w.webp)
...
![https://pic2.zhimg.com/80/v2-b442be6fbd1b6180ad93616128b86dad_1440w.webp](https://pic2.zhimg.com/80/v2-b442be6fbd1b6180ad93616128b86dad_1440w.webp)
...
![https://pic2.zhimg.com/80/v2-a77e47eba6ca86e5f4fca6847dc2cb49_1440w.webp](https://pic2.zhimg.com/80/v2-a77e47eba6ca86e5f4fca6847dc2cb49_1440w.webp)
...
![https://pic2.zhimg.com/80/v2-5c1aa264a3c317b890c4259fd15a0ef1_720w.webp](https://pic2.zhimg.com/80/v2-5c1aa264a3c317b890c4259fd15a0ef1_720w.webp)
...
![https://pic3.zhimg.com/80/v2-ef8adb23ef7930365211d6c4fcacab8a_720w.webp](https://pic3.zhimg.com/80/v2-ef8adb23ef7930365211d6c4fcacab8a_720w.webp)
...
[https://zhuanlan.zhihu.com/p/660385197](https://zhuanlan.zhihu.com/p/660385197)